"""Bet_LogReg — sports-ticket Won/Lost logistic regression (lesson spec + helpers).

Educational use only. Not betting advice. Synthetic blotter.
"""
...
def main():
    ...
    p.add_argument("--data", default="data/sports_tickets.csv")
