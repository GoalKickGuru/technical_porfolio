"""
Banking Model Representation
Linear regression model f_w,b(x) = w*x + b for income-based loan underwriting.
"""
import numpy as np
...
if __name__ == "__main__":
    ...
    print("Training data (income, loan):", x_train, y_train)
    print("Fitted underwriting rule: max_loan = {:.0f} * income + {:.0f}".format(w, b))
